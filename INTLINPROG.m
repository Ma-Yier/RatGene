...
if isfield(options,'IntegerTolerance')
    params.IntFeasTol = options.IntegerTolerance;
end

% set solution pool
if isfield(options,'NumSol')
    params.PoolSolutions = options.NumSol;
end

if isfield(options,'SearchMode')
    params.PoolSearchMode = options.SearchMode;
end
